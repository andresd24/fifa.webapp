    ...
    UserEditComponent.prototype.onSubmit = function () {
        ...
        this._userService.update_user(this.user)
            ...
            if (!response.user) {
                ...
                var imageUrl = _this.url + "upload-image-user/" + _this.user._id + "/" + _this.token;
                _this._uploadService.make_file_request(imageUrl, [], _this.filesToUpload, _this.token, 'image')
